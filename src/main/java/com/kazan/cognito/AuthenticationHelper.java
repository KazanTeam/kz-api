...
public class AuthenticationHelper {
    ...
    public AuthenticationHelper(String userPoolID, String clientid, AWSCognitoIdentityProvider cognitoClient) {
        do {
     ...
     */
    public RespondToAuthChallengeResult gerformSRPAuthentication(String username, String password) {
        ...
        try {
            ...
            if (ChallengeNameType.PASSWORD_VERIFIER.toString().equals(initiateAuthResult.getChallengeName())) {
                ...
                result = cognitoClient.respondToAuthChallenge(challengeRequest);
